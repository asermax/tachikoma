...
- **One page per pattern** (\`<pattern-slug>.md\`, named for the skill problem it records — a gap in
  an existing skill or a workflow no skill covers — broad and future-mergeable, never incident- or
  date-scoped) with four sections:
