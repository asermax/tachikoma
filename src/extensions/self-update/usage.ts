...
A successful upgrade or restart re-execs the process, so the call returns nothing. After an upgrade, do not report success until the post-restart "back online" notification appears — a failed upgrade rolls back automatically on the next boot.
