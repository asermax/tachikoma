...
class TestUpdateWorkflowState:
    @pytest.mark.asyncio
    async def test_start_step(self, repository, tmp_path):
    ...
    @pytest.mark.asyncio
    async def test_complete_step(self, repository, tmp_path):
        state = _make_state(
            step_states={
                "01-plan": "started",
                "02-execute": "pending",
    ...
    @pytest.mark.asyncio
    async def test_skip_skippable_step(self, repository, tmp_path):
        state = _make_state(
            step_states={
                "01-plan": "completed",
                "02-execute": "pending",
    ...
    @pytest.mark.asyncio
    async def test_complete_pending_rejected(self, repository, tmp_path):
        state = _make_state(
            step_states={
                "01-plan": "pending",
                "02-execute": "pending",
    ...
    @pytest.mark.asyncio
    async def test_invalid_workflow_id(self, repository, tmp_path):
        result = await handle_update_workflow_state(
            "nonexistent",
            "01-plan",
            "start",
    ...
    @pytest.mark.asyncio
    async def test_concurrent_workflows_independent(self, repository, tmp_path):
