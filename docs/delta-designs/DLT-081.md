...
**Then**: The instructions guide the agent to use `step_path` as the base for accessing references and scripts. The agent reads reference files and executes scripts using paths relative to `step_path`.
